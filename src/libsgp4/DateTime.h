...
public:
     ...
     */
    DateTime(int year, int month, int day, int hour, int minute, int secondd)
    {
        Initialise(year, month, day, hour, minute, secondd, 0);
    }
    DateTime(int year, int month, int day, int hour, int minute, int secondd, int microsecondd)
    {
        Initialise(year, month, day, hour, minute, secondd, microsecondd);
    }
